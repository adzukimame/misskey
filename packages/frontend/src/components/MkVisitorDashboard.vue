	...
	<div :class="[$style.main, $style.panel]">
		...
		<div :class="$style.mainFg">
			...
			<div class="_gaps_s" :class="$style.mainActions">
				<MkButton :class="$style.mainAction" full rounded :gradate="!instance.disableRegistration" data-cy-signup style="margin-right: 12px;" @click="signup()">{{ i18n.ts.joinThisServer }}</MkButton>
				<MkButton :class="$style.mainAction" full rounded :gradate="instance.disableRegistration" @click="exploreOtherServers()">{{ i18n.ts.exploreOtherServers }}</MkButton>
